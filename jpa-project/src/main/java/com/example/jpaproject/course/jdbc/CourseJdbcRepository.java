package com.example.jpaproject.course.jdbc;
...
public class CourseJdbcRepository {
  ...
  @Autowired
   ...
   //private static String INSERT_QUERY = "insert into course (id,name,author) values (1,'Intro to Spring Boot','Baris Kaya');";
